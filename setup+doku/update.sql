...
# ==== 2.2.2 => 2.2.3 ====
UPDATE `d3_cfg_mod` SET `OXVERSION` = '2.2.3', `OXINSTALLDATE` = NOW(), `OXNEWREVISION` = '45' WHERE `OXMODID` = 'd3_googleanalytics';

# ==== 2.2.3 => 2.3.0 ====
UPDATE `d3_cfg_mod` SET `OXVERSION` = '2.3.0', `OXINSTALLDATE` = NOW(), `OXNEWREVISION` = '48' WHERE `OXMODID` = 'd3_googleanalytics';
