[{if $oD3GASettings->getValue('blD3GASetRemarketing') &&
    ...
    [{block name="UniversalAdwordsRemarketing"}]
        [{*-- Google Code f�r ein Remarketing-Tag --
            --------------------------------------------------
            Remarketing-Tags d�rfen nicht mit personenbezogenen Daten verkn�pft oder auf Seiten platziert werden,
            die sensiblen Kategorien angeh�ren. Weitere Informationen und Anleitungen zur Einrichtung des Tags
